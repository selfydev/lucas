...
var LazyLoadedSessionRecording = /** @class */ (function () {
    ...
    LazyLoadedSessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        var sessionStarting = isSessionStartingEvent(event);
        if (sessionEndingPayload || sessionStarting) {
            // Adjust timestamp from payload to avoid artificially extending session duration
            var payload = (sessionEndingPayload !== null && sessionEndingPayload !== void 0 ? sessionEndingPayload : event.data.payload);
        ...
        var targetSessionId = (_b = sessionEndingPayload === null || sessionEndingPayload === void 0 ? void 0 : sessionEndingPayload.currentSessionId) !== null && _b !== void 0 ? _b : this._sessionId;
        var targetWindowId = (_c = sessionEndingPayload === null || sessionEndingPayload === void 0 ? void 0 : sessionEndingPayload.currentWindowId) !== null && _c !== void 0 ? _c : this._windowId;
        ...
        var eventToSend = ((_d = this._instance.config.session_recording.compress_events) !== null && _d !== void 0 ? _d : true) ? compressEvent(event) : event;
