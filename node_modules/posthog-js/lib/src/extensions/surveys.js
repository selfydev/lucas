...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this.handlePopoverSurvey = function (survey) {
            ...
            if (delaySeconds <= 0) {
                return (0, preact_2.render)((0, jsx_runtime_1.jsx)(SurveyPopup, { posthog: _this._posthog, survey: survey, removeSurveyFromFocus: _this._removeSurveyFromFocus }), shadow);
            }
            var timeoutId = setTimeout(function () {
                ...
                (0, preact_2.render)((0, jsx_runtime_1.jsx)(SurveyPopup, { posthog: _this._posthog, survey: __assign(__assign({}, survey), { appearance: __assign(__assign({}, survey.appearance), { surveyPopupDelaySeconds: 0 }) }), removeSurveyFromFocus: _this._removeSurveyFromFocus }), shadow);
            }, delaySeconds * 1000);
        ...
        this.renderSurvey = function (survey, selector) {
            ...
            (0, preact_2.render)((0, jsx_runtime_1.jsx)(SurveyPopup, { posthog: _this._posthog, survey: survey, removeSurveyFromFocus: _this._removeSurveyFromFocus, isPopup: false }), selector);
        };
    ...
    SurveyManager.prototype._handleUrlPrefill = function (survey) {
        ...
        try {
            ...
            var startQuestionIndex = (0, survey_url_prefill_1.calculatePrefillStartIndex)(survey.questions, prefilledIndices);
            ...
            if (survey.enable_partial_responses || isSurveyCompleted) {
                survey_utils_1.SURVEY_LOGGER.info("[Survey Prefill] Auto-submitting survey (completed: ".concat(isSurveyCompleted, ")"));
...
function Questions(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("form", { className: "survey-form", name: "surveyForm", children: [isPopup && ((0, jsx_runtime_1.jsx)(QuestionHeader_1.Cancel, { onClick: function () {
                    onPopupSurveyDismissed();
