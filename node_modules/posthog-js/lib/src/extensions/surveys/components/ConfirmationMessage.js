...
function ConfirmationMessage(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "thank-you-message", role: "status", tabIndex: 0, "aria-atomic": "true", children: [isPopup && (0, jsx_runtime_1.jsx)(QuestionHeader_1.Cancel, { onClick: function () { return onClose(); } }), (0, jsx_runtime_1.jsx)("h3", { className: "thank-you-message-header", children: header }), description &&
                ...
                }), isPopup && ((0, jsx_runtime_1.jsx)(BottomSection_1.BottomSection, { text: appearance.thankYouMessageCloseButtonText || 'Close', submitDisabled: false, appearance: appearance, onSubmit: function () { return onClose(); } }))] }));
}
