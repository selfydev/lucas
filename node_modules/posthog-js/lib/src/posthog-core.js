...
var PostHog = /** @class */ (function () {
    function PostHog() {
        ...
        this.productTours = new posthog_product_tours_1.PostHogProductTours(this);
    ...
    PostHog.prototype.opt_in_capturing = function (options) {
        ...
        if ((0, core_1.isUndefined)(options === null || options === void 0 ? void 0 : options.captureEventName) || (options === null || options === void 0 ? void 0 : options.captureEventName)) {
            this.capture((_c = options === null || options === void 0 ? void 0 : options.captureEventName) !== null && _c !== void 0 ? _c : '$opt_in', options === null || options === void 0 ? void 0 : options.captureProperties, { send_instantly: true });
        }
        if (this.config.capture_pageview) {
